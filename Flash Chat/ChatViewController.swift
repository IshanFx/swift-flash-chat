...
class ChatViewController: UIViewController,UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        //Specify Nibfile name to register
    ...
    @IBAction func sendPressed(_ sender: AnyObject) {
        ...
        if messageTextfield.text != "" {
            ...
            var messageObj = ["Sender":Auth.auth().currentUser?.email,"Message":messageTextfield.text!]
            message.childByAutoId().setValue(messageObj) { (reference,error) in
                
                //enable view again to  give a ablity to send again
    ...
    func retriveMessages(){
        ...
        messagesDb.observe(.childAdded) { (snapshot) in
            ...
            let dataSnapshot = snapshot.value as! Dictionary<String,String>
            let sender = dataSnapshot["Sender"]!
            let message = dataSnapshot["Message"]!
